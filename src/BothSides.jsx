    ...
    <section className="main-section">
          <div className="main-container-left">
            <div className="left-content">
              <h1 className="events-left">Events</h1>
              <p className="events-p-left">Weekend parties in Tbilisi</p>
          ...
          <div className="main-container-right">
            <div className="right-content">
              <h1 className="events-right">Places</h1>
              <p className="events-p-right">A must see places near Tbilisi</p>
              <div className="btn-div">
                <Link to='/places'>
                  <button className="btn right-btn">
                    View more
        ...
        />
          ...
          <div className="copyright-container">
            <p className="footer-copyright">© 2022 CANDO. All rights reserved.</p>
          </div>
        </footer>
        </>
  )
